...
Users are also handled this way by having a <USERNAME>.nix file that you define your userland then enabled in the config file for the host you would like to add said user to.
...
To use this flake you need to first have NixOS. 
